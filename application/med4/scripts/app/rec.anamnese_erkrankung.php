...
if(isset($_REQUEST['sess_pos']) && $_REQUEST['sess_pos'] != ''){
   ...
   $form_id  = isset($arr_sess['anamnese_erkrankung_id']) ? $arr_sess['anamnese_erkrankung_id'] : '';
}else{
   $form_id  = isset($_REQUEST['anamnese_erkrankung_id']) ? $_REQUEST['anamnese_erkrankung_id'] : '';
}
