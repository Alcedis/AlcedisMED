...
if(isset($_REQUEST['sess_pos']) && $_REQUEST['sess_pos'] != ''){
   ...
   $form_id  = isset($arr_sess['zytologie_aberration_id']) ? $arr_sess['zytologie_aberration_id'] : '';
}else{
   $form_id  = isset($_REQUEST['zytologie_aberration_id']) ? $_REQUEST['zytologie_aberration_id'] : '';
}
