...
$searchFields = array(
   'code'  => array('type' => 'string', 'field'   => "vi.code"),
   'bez'   => array('type' => 'string', 'field'   => "vi.bez"),
);

$queryMod = queryModifier::create($db, $smarty)
   ->setCookie($cookie)
   ->setQuery($querys['vorlage_icd10'])
   ->setSearchFields($searchFields)
   ->setOrderBy('vi.code ASC')
;

data2list($db, $fields, $queryMod->query());

$arr_menubar['vorlage_icd10'] = array('new' => ($permission->action('I') === true));
