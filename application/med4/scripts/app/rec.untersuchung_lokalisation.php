...
$table = 'untersuchung_lokalisation';

if(isset($_REQUEST['sess_pos']) && $_REQUEST['sess_pos'] != ''){
   $arr_sess = edit_pos($smarty);
   $form_id  = isset($arr_sess['untersuchung_lokalisation_id']) ? $arr_sess['untersuchung_lokalisation_id'] : '';
}else{
   $form_id  = isset($_REQUEST['untersuchung_lokalisation_id']) ? $_REQUEST['untersuchung_lokalisation_id'] : '';
}
...
if ($form_id == '' && $erkrankungSeite != null && $action == NULL) {
