...
if(isset($_REQUEST['sess_pos']) && $_REQUEST['sess_pos'] != ''){
    ...
    $form_id  = isset($arr_sess['erkrankung_synchron_id']) ? $arr_sess['erkrankung_synchron_id'] : '';
}else{
    $form_id  = isset($_REQUEST['erkrankung_synchron_id']) ? $_REQUEST['erkrankung_synchron_id'] : '';
}
