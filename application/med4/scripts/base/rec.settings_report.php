...
$table    = 'settings_report';
$form_id  = isset($_REQUEST['settings_report_id']) ? $_REQUEST['settings_report_id'] : '';
$location = 'index.php?page=list.settings_report';
...
show_record($smarty, $db, $fields, 'settings_report', $form_id, '');

$smarty
   ->assign('button', $button)
   ->assign('back_btn', 'page=list.settings_report');
;
