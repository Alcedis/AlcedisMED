...
$table    = 'settings_import';
$form_id  = isset($_REQUEST['settings_import_id']) ? $_REQUEST['settings_import_id'] : '';
$location = 'index.php?page=list.settings_import';
...
show_record($smarty, $db, $fields, 'settings_import', $form_id, '');

$smarty
   ->assign('button', $button)
   ->assign('back_btn', 'page=list.settings_import');
;
