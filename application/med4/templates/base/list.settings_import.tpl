...
{section name=i loop=$fields.settings_import_id.value}
{html_odd_even var="class" key=%i.index%}
<tr>
   <td class="{$class}" align="center"><a href="{$form_rec}&amp;settings_import_id={$fields.settings_import_id.value[i]}" class="edit"></a></td>
