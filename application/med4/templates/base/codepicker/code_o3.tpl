        ...
        {section name=i loop=$fields.sub_level.value}
         <tr>
                <td class="edt" align="center">
                   <span class="link link_code" onclick='changeCodepicker({literal}{history:1,{/literal}code:"{$fields.code.value[i]}", page: "code_o3_gruppen"{literal}}{/literal}, null, 1);'>
                      <img class="picker-img" src="media/img/base/picker-folder.png"/>
                   </span>
                </td>
            <td class="edt" align="center">
               <strong>{if is_numeric($fields.code.value[i])}{$fields.code.value[i]}...{else}{#head_diag#}{/if}</strong>
            </td>
            <td class="edt">
