...
<div id="codepicker-form"{if count($top10) > 0 && !$fromHistory} style="display:none;"{/if}>
    <table class="formtable">
       <tr>
       	<td class="head" colspan="3" align="center">{#head_ops#}</td>
       </tr>
      ...
      <table class="formtable">
         ...
         {section name=i loop=$fields.sub_level.value}
            ...
            <td class="edt" align="center">
               <span class="link link_code" onclick='changeCodepicker({literal}{{/literal}code:"{$fields.code.value[i]}", page: "code_ops_gruppen"{literal}}{/literal}, null, 1);'>
