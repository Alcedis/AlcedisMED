...
<levelone   xmlns="urn::hl7-org/cda"
   ...
   <clinical_document_header>
      ...
      <document_type_cd V="DMP_021A" S="1.2.276.0.76.5.100" SN="KBV" DN="Erst-Dokumentation Brustkrebs"/>
   ...
   <body>
      <section>
                  ...
                  <local_markup descriptor="sciphox" ignore="all">
                     <sciphox:sciphox-ssu country="de" version="v1" type="observation">
                        <sciphox:Beobachtungen>
                           {foreach from=$einschreibung item=beobachtung}
                              <sciphox:Beobachtung>
         ...
         {if count($anamnese) > 0}
            <paragraph>
               <caption>
                  <caption_cd DN="Anamnese und Behandlungsstatus Primärtumor/kontralateraler Brustkrebs"/>
               </caption>
               <content>
                  <local_markup descriptor="sciphox" ignore="all">
                     <sciphox:sciphox-ssu country="de" version="v1" type="observation">
                        <sciphox:Beobachtungen>
                           {foreach from=$anamnese item=beobachtung}
                              <sciphox:Beobachtung>
                                 <sciphox:Parameter DN="{$beobachtung.parameter}"/>
         ...
         {/if}
         {if count($befund_primaer) > 0}
            <paragraph>
               <caption>
                  <caption_cd DN="Aktueller Befundstatus Primärtumor/kontralateraler Brustkrebs"/>
               </caption>
               <content>
                  <local_markup descriptor="sciphox" ignore="all">
                     <sciphox:sciphox-ssu country="de" version="v1" type="observation">
                        <sciphox:Beobachtungen>
                           {foreach from=$befund_primaer item=beobachtung}
                              <sciphox:Beobachtung>
                                 <sciphox:Parameter DN="{$beobachtung.parameter}"/>
                                 {if is_array($beobachtung.ergebnistext) }
                                    {foreach from=$beobachtung.ergebnistext item=ergebnistext}
         ...
         {if count($behandlung_primaer) > 0}
            <paragraph>
               <caption>
                  <caption_cd DN="Behandlung Primärtumor/kontralateraler Brustkrebs"/>
               </caption>
               <content>
                  <local_markup descriptor="sciphox" ignore="all">
                     <sciphox:sciphox-ssu country="de" version="v1" type="observation">
         ...
         {/if}
         {if count($befund_rezidiv) > 0}
            <paragraph>
               <caption>
                  <caption_cd DN="Befunde und Therapie lokoregionäres Rezidiv"/>
               </caption>
               <content>
                  <local_markup descriptor="sciphox" ignore="all">
                     <sciphox:sciphox-ssu country="de" version="v1" type="observation">
                        <sciphox:Beobachtungen>
                           {foreach from=$befund_rezidiv item=beobachtung}
                              <sciphox:Beobachtung>
                                 <sciphox:Parameter DN="{$beobachtung.parameter}"/>
                                  {if is_array($beobachtung.ergebnistext) }
                                    {foreach from=$beobachtung.ergebnistext item=ergebnistext}
         ...
         {/if}
         {if count($befund_metastase) > 0}
            <paragraph>
               <caption>
                  <caption_cd DN="Befunde und Therapie Fernmetastasen"/>
               </caption>
               <content>
                  <local_markup descriptor="sciphox" ignore="all">
                     <sciphox:sciphox-ssu country="de" version="v1" type="observation">
                        <sciphox:Beobachtungen>
                           {foreach from=$befund_metastase item=beobachtung}
                              <sciphox:Beobachtung>
                                 <sciphox:Parameter DN="{$beobachtung.parameter}"/>
                                 {if is_array($beobachtung.ergebnistext) }
                                    {foreach from=$beobachtung.ergebnistext item=ergebnistext}
