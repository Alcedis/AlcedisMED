   ...
   <tr>
      ...
      <td class="even" style="vertical-align:middle">
      	<table class="button-container" border="0">
      		<tr>
					<td><input type="submit" class="dont_prevent_double_save button_get_pdf_rpt" name="action[print][multiple]" value="" alt=""/></td>
					<td><input type="submit" name="action[print][multiple]" class="dont_prevent_double_save button_gen_rpt_text" value="{#lbl_export#}" alt=""/></td>
      		</tr>
      	</table>
      </td>
      <td class="even" style="width: 190px; text-align:center">
   		<a class="termin-erinnerung" href="index.php?page=list.termin_erinnerung">
				<b>{#lbl_terinnerung#}</b>
			</a>
      </td>
   </tr>
...
<table class="listtable bfl">
	<tr>
		...
		<td class="subhead ext-search cookie-erledigt cookietype-check" style="width:80px;">{#lbl_erledigt#}</td>
		<td class="subhead ext-search cookie-erinnern cookietype-check" style="width:80px;">{#lbl_erinnern#}</td>
		<td class="subhead unsortable"></td>
	</tr>

	{include file=app/list/list.termin.tpl}
