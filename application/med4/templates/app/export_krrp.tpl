...
{if $view == 'error'}
      ...
      <tr>
         <td class="head" colspan="2" align="center">{#head_ekrrp#}</td>
      </tr>
      <tr>
         <td class="edt" colspan="2" align="center">
            ...
            <div style="margin:15px;">
               <a href="index.php?page=export_krrp">{#lbl_zurueck#}</a>
            </div>
         </td>
      </tr>
   </table>
         ...
         <td class="edt" colspan="2" align="center">
            <!-- div class="msgbox" -->
               ...
               {if $cnt_patient_invalid}
                  ...
                  <div style="width: 300px; text-align:left; list-style-image:url(media/img/base/editdelete.png)">
                     <ul>
                     {foreach from=$result.invalid item=patient}
                        <li><a class="visible-anchor" href="#" onclick="execute_request( this, 'export_krrp_msg&amp;export_id={$export_id}&amp;patient_id={$patient.patient_id}', null, [] )" >{$patient.bez}</a></li>
                     {/foreach}
                     </ul>
                  </div>
               {/if}
               ...
               <div style="width: 300px; text-align:left; list-style-image:url(media/img/base/ok_small.png)">
                  <ul>
                  {foreach from=$result.valid item=patient}
                     <li>{$patient.bez}</li>
                  {/foreach}
                  </ul>
               </div>
               <table style="margin:30px;">
                  ...
                  <tr>
                     <td><a href="{$zip_gpg_url}">{#img_gpg_file#}</a></td>
                     <td><a class="visible-anchor" href="{$zip_gpg_url}" style="font-size:14px; font-weight:bold; margin:5px">{$zip_gpg_filename}</a></td>
                  </tr>
                  <tr>
                     <td colspan="2" align="center" style="font-size:14px; font-weight:bold;">
                        {#lbl_download#}
                  ...
                  <tr>
                     <td><a href="{$zip_url}">{#img_gpg_file#}</a></td>
