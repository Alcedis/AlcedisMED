...
<table class="formtable">
    {html_set_header caption=#head_administrativ# class="head"}
    <tr>
        <td class="lbl">{#fall_nr#}</td>
        <td class="edt">
           <b>{$fallNr}</b>
        </td>
    </tr>

    {if strlen($_dmp_brustkrebs_ed_pnp_2013_id_value) > 0}
...
<div>
    {$_dmp_brustkrebs_ed_pnp_2013_id}
