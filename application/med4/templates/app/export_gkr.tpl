...
{if $view == 'error'}
      ...
      <tr>
         <td class="head" colspan="2" align="center">{#head_gkr#}</td>
      </tr>
      <tr>
         <td class="edt" colspan="2" align="center">
            ...
            <div style="margin:15px;">
               <a href="index.php?page=export_gkr&amp;{$sid}">{#lbl_zurueck#}</a>
            </div>
         </td>
      </tr>
   </table>
               ...
               {if $cnt_patient_invalid}
                  ...
                  <div style="width: 300px; text-align:left; list-style-image:url(media/img/base/editdelete.png)">
                     ...
                     {foreach from=$result.invalid item=patient}
                        <li><a class="visible-anchor" href="#" onclick="execute_request( this, 'export_gkr_msg&amp;export_id={$export_id}&amp;patient_id={$patient.patient_id}&amp;{$sid}', null, [] )" >{$patient.bez}</a></li>
                     {/foreach}
                     </ul>
                  </div>
               {/if}
...
{else}
   <table class="formtable">
		...
		{html_set_row    caption=$_sel_erstmedlung_erneut_lbl   input=$_sel_erstmedlung_erneut}
		<tr>
			<td class="edt" colspan="2" align="center">
