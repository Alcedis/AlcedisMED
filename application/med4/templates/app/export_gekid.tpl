...
{if $view == 'error'}
      ...
      <tr>
         <td class="head" colspan="2" align="center">{#head_gekid#}</td>
      </tr>
      <tr>
         <td class="edt" colspan="2" align="center">
            ...
            <div style="margin:15px;">
               <a href="index.php?page=export_gekid&amp;{$sid}">{#lbl_zurueck#}</a>
            </div>
         </td>
      </tr>
   </table>
               ...
               {if $cnt_patient_invalid}
                  ...
                  <div style="width: 400px; text-align:left; list-style-image:url(media/img/base/editdelete.png)">
                     ...
                     {foreach from=$result.invalid item=ekr}
                        <li><a class="visible-anchor" href="#" onclick="execute_request( this, 'export_gekid_msg&amp;export_id={$export_id}&amp;ekr_id={$ekr.ekr_id}&amp;{$sid}', null, [] )" >{$ekr.bez}</a></li>
                     {/foreach}
                     </ul>
                  </div>
               {/if}
