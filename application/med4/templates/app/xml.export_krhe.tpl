      ...
      {foreach from=$data.Daten item=cur_pat}
         <Patient>
            ...
            <Tumor>
               ...
               {xml_tag name='Diagnosetag_kuenstlich'       value=$cur_pat.Diagnosetag_kuenstlich}
               {xml_tag name='Diagnosemonat'                value=$cur_pat.Diagnosemonat}
               {xml_tag name='Diagnosemonat_kuenstlich'     value=$cur_pat.Diagnosemonat_kuenstlich}
               {xml_tag name='Diagnosejahr'                 value=$cur_pat.Diagnosejahr}
               {xml_tag name='Wievielter_Tumor'             value=$cur_pat.Wievielter_Tumor}
               ...
               {xml_tag name='Topographie_Freitext'         value=$cur_pat.Topographie_Freitext}
               ...
               {xml_tag name='Multiplizitaet'               value=$cur_pat.Multiplizitaet}
               ...
               {xml_tag name='Therapieintention'            value=$cur_pat.Therapieintention}
               {xml_tag name='Patient_informiert'           value=$cur_pat.Patient_informiert}
            </Tumor>
         </Patient>
      {/foreach}
   </Daten>
