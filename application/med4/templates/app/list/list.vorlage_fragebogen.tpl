...
{section name=i loop=$fields.vorlage_fragebogen_id.value}
	{html_odd_even var="class" key=%i.index%}
	<tr>
	   <td class="{$class}"  align="center"><a href="index.php?page=rec.vorlage_fragebogen&amp;vorlage_fragebogen_id={$fields.vorlage_fragebogen_id.value[i]}" class="edit"></a></td>
