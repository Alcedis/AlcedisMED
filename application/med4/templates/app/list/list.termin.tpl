...
{section name=i loop=$fields.termin_id.value}
	...
	<tr>
		...
		<td class="{$class}"><span style="font-size:9pt">{$fields.erledigt.bez[i]}</span></td>
		<td class="{$class}"><span style="font-size:9pt">{$fields.erinnerung.bez[i]}</span></td>
		<td class="{$class}">
...
{sectionelse}
	{html_set_header class="even no-data" colspan="11" caption=#no_dataset#}
{/section}
