...
class reportContentD05_2 extends reportExtensionD
{
   ...
   public function generate()
   {
      ...
      $additionalContent['condition'] = "LEFT(IFNULL(sit.diagnose_c19_zuordnung, sit.diagnose), 3) IN ('C19', 'C20') AND YEAR(bezugsdatum) BETWEEN {$firstJahr} AND {$bezugsjahr}";
