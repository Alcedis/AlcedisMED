...
$query_erkrankung_recht = "SELECT code, bez FROM l_basic WHERE klasse='erkrankung'";

$fields = array(
	'recht_erkrankung_id'  => array( 'req' => 0, 'size' => '', 'maxlen' => '11', 'type' => 'hidden', 'ext' => '' ),
	'recht_id'             => array( 'req' => 0, 'size' => '', 'maxlen' => '11', 'type' => 'hidden', 'ext' => '' ),
	'erkrankung'           => array( 'req' => 1, 'size' => '', 'maxlen' => '',   'type' => 'query' , 'ext' => $query_erkrankung_recht, 'preselect' => "klasse = 'erkrankung' AND code" ),
