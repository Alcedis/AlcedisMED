...
class Cdmp_2014_0_View extends CExportDefaultView
{
    ...
    {
        parent::ReadConfigs();
        $this->m_smarty->config_load('../feature/export/dmp_2014/dmp_2014_0.conf', 'export_dmp_2014');
    ...
    {
        return "../feature/export/dmp_2014/dmp_2014_0_view.tpl";
    }
    ...
    protected function _CreateAllErrorsViewFields()
    {
        ...
        if (($result !== false) && is_array($result)) {
            ...
            //$data['errors'] = $this->_getWarnings(HDmp::parseErrorsFromProtocol($result['xml_protokoll']));
            $data['errors'] = HelperDmp::parseErrorsFromProtocol($result['xml_protokoll']);
            // Ticket #12416
            $data['errors'] = $this->removeJavaVersionWarning($data['errors']);
