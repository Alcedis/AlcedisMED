    ...
    <table class="listtable bfl">
        ...
        {section name=i loop=$errorlist_data}
            ...
            <tr>
                ...
                <td class="{$class}" align="center">
                    <a href="#" onclick="execute_request( this, 'krbw&amp;feature=export&amp;action=view_errors&amp;export_id={$errorlist_data[i].export_section_log_id}', null, [] )" title="{#tooltip_view_errors#}" >
...
{else}
    <table class="formtable">
        ...
        {html_set_row caption=$_pruefcode_lbl           input=$_pruefcode}
        <tr>
            <td class="edt" colspan="2" align="center">
                <table>
                    <tr>
                        ...
                        <td style="border: 0px;">
                            <div id="buttonbar">
                                <a class="button_large" style="margin-top: 3px;" href="index.php?page=history&feature=export&exportname=krbw">{#start_history#}</a>
                            </div>
                        </td>
                    </tr>
                </table>
