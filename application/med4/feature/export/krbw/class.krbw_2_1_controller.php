...
require_once( 'class.krbw_2_1_view.php' );
require_once( 'class.krbw_2_1_model.php' );

class Ckrbw_2_1_Controller extends CExportDefaultController
{
    ...
    public function Create( $absolute_path, $export_name, $smarty, $db, $error_function = '' )
    {
        ...
        $this->m_model = new Ckrbw_2_1_Model;
    ...
    {
        $this->m_view = new Ckrbw_2_1_View;
