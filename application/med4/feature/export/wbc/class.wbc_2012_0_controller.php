...
require_once( 'class.wbc_2012_0_view.php' );
require_once( 'class.wbc_2012_0_model.php' );

class Cwbc_2012_0_Controller extends CExportDefaultController
{
    ...
    public function Create( $absolute_path, $export_name, $smarty, $db, $error_function = '' )
    {
        ...
        $this->m_model = new Cwbc_2012_0_Model;
    ...
    {
        $this->m_view = new Cwbc_2012_0_View;
