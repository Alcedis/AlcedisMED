...
$parameter['melder_id'] = isset($_REQUEST['sel_melde_user_id']) ? $_REQUEST['sel_melde_user_id'] : '0';
$parameter['datum_von'] = isset($_REQUEST['sel_von_date']) ? date('Y-m-d', strtotime($_REQUEST['sel_von_date'])) : '0000-00-00';
$parameter['datum_bis'] = isset($_REQUEST['sel_bis_date']) ? date('Y-m-d', strtotime($_REQUEST['sel_bis_date'])) : '2999-12-31';
...
if ((strlen($parameter['org_id']) > 0) &&
    ...
    $export = CExportFactory::CreateObject($smarty, $db, 'gekid_plus', '1.5', 'ext_err');
