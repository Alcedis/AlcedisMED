...
$parameter[ 'datum_von' ] = ( ( isset( $_REQUEST[ 'sel_von_date' ] ) &&
                              ( strlen( $_REQUEST[ 'sel_von_date' ] ) > 0 ) ) ) ? date( "Y-m-d", strtotime( $_REQUEST[ 'sel_von_date' ] ) ) : '0000-00-00';
$parameter[ 'datum_bis' ] = ( ( isset( $_REQUEST[ 'sel_bis_date' ] ) &&
                              ( strlen( $_REQUEST[ 'sel_bis_date' ] ) > 0 ) ) ) ? date( "Y-m-d", strtotime( $_REQUEST[ 'sel_bis_date' ] ) ) : date( "Y-m-d" );
...
if ( ( strlen( $parameter[ 'org_id' ] ) > 0 ) &&
    ...
    $export = CExportFactory::CreateObject( $smarty, $db, 'wbc', '2012.0', 'ext_err' );
