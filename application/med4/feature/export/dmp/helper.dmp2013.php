...
require_once('class.dmp_2013_0_model.php');
...
class HDmp2013
{
    ...
    {
        $absolutePath = "feature/export/dmp/";
        HDatabase::LoadExportSettings($db, $parameters, 'dmp');
        $model = new Cdmp_2013_0_Model;
        $model->Create($absolutePath, 'dmp', $smarty, $db);
        $model->SetParameters($parameters);
        $exportRecord = new RExport;
        $exportRecord->SetExportName('dmp');
