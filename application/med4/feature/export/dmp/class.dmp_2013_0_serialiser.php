...
require_once('reports/pdf/b/dmp_begleitzettel_2013.php');
require_once('core/class/report/alcReportPdf.php');
require_once('helper.dmp2013.php');

class Cdmp_2013_0_Serialiser extends CExportXmlSerialiser
{
                ...
                if ($section->GetBlock() !== 'header') {
                    switch ($section->GetBlock()) {
                        ...
                        case 'ed_pnp' :
                            ...
                            $data['body'] = $section->GetDaten();
                            $filePostfix = 'EBK';
                            $template = 'dmp_2013_0_ed_pnp.tpl';
                            $type = 'ed';
                            break;
                        case 'fd' :
    ...
    public function Write($parameters)
    {
        ...
        if (!$anyFilesExportable) {
            ...
            $zipFileUrl = "index.php?page=dmp&feature=export&action=download&type=zip&file={$zipPath}";
            $paths = HelperDmp::cryptZip($parameters, $zipExportPath, $zipfile, '2000-01-01');
            $xkmFileUrl = "index.php?page=dmp&feature=export&action=download&type=bin&file={$paths['xkmFilePath']}";
            $xkmCryptoProtocolUrl =
                "index.php?page=dmp&feature=export&action=download&type=pdf&file={$paths['xkmCryptoProtocolPath']}";
            ...
            $idxUrl =
                "index.php?page=dmp&feature=export&action=download&type=xml&file={$zipExportPath}{$idxFilename}";
            ...
            $xml = $this->m_internal_smarty->fetch('dmp_2013_0_begleitdatei.tpl');
            ...
            $renderer->addPage();
            $begleitzettel = new reportContentDmp_begleitzettel_2013(
