        ...
        <tr>
            <td class="edt" width="33%">
                {if $show_xkm}
                    ...
                    <a class="visible-anchor" href="index.php?page=report&amp;sub=b&amp;name=dmp_begleitzettel_2013&amp;type=pdf&amp;footer=none&amp;action=report" target="_blank" >{#begleitzettel#}</a><br><br>
                    </br></br>
                {/if}
            </td>
            <td class="edt" width="33%">
    ...
    <table class="formtable">
        ...
        {foreach from=$dmp_ed_patdat item=patient_ed}
            <tr>
                ...
                {else}
                    <td class="edt"><a class="visible-anchor" href="#" onclick="execute_request( this, 'dmp&amp;feature=export&amp;action=view_all_errors&amp;export_type=ed&amp;export_id={$patient_ed.dmp_dbid}', null, [] )" >{$patient_ed.status}</a></td>
                {/if}
        ...
        {foreach from=$dmp_ed_pnp_patdat item=patient_ed_pnp}
            <tr>
                ...
                {else}
                    <td class="edt"><a class="visible-anchor" href="#" onclick="execute_request( this, 'dmp&amp;feature=export&amp;action=view_all_errors&amp;export_type=ed_pnp&amp;export_id={$patient_ed_pnp.dmp_dbid}', null, [] )" >{$patient_ed_pnp.status}</a></td>
                {/if}
        ...
        {foreach from=$dmp_fd_patdat item=patient_fd}
            <tr>
                ...
                {else}
                    <td class="edt"><a class="visible-anchor" href="#" onclick="execute_request( this, 'dmp&amp;feature=export&amp;action=view_all_errors&amp;export_type=fd&amp;export_id={$patient_fd.dmp_dbid}', null, [] )" >{$patient_fd.status}</a></td>
                {/if}
...
{elseif $view_type == 'errorlist'}
    ...
    <table class="listtable bfl">
        ...
        <td class="{$class}" align="center">
            <a href="#" onclick="execute_request( this, 'dmp&amp;feature=export&amp;action=view_errors&amp;export_id={$errorlist_data[i].export_section_log_id}', null, [] )" title="{#tooltip_view_errors#}" >
        ...
        {section name=i loop=$warninglist_data}
            ...
            <tr>
                ...
                <td class="{$class}" align="center">
                    <a href="#" onclick="execute_request( this, 'dmp&amp;feature=export&amp;action=view_warnings&amp;export_id={$warninglist_data[i].export_section_log_id}', null, [] )" title="{#tooltip_view_warnings#}" >
            ...
            <td class="edt" colspan="2" align="center">
                <table>
                    <tr>
                        ...
                        <td style="border: 0px;">
                            <div id="buttonbar">
                                <a class="button_large" style="margin-top: 3px;" href="index.php?page=history&feature=export&exportname=dmp">{#start_history#}</a>
                            </div>
                        </td>
                    </tr>
                </table>
