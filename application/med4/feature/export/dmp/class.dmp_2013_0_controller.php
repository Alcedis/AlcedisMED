...
require_once('class.dmp_2013_0_view.php');
require_once('class.dmp_2013_0_model.php');

class Cdmp_2013_0_Controller extends CExportDefaultController
{
    ...
    public function Create($absolutePath, $exportName, $smarty, $db, $errorFunction = '')
    {
        ...
        $this->m_model = new Cdmp_2013_0_Model;
    ...
    {
        $this->m_view = new Cdmp_2013_0_View;
        $this->m_view->Create(
