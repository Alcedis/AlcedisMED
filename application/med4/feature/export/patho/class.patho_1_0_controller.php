...
require_once( 'class.patho_1_0_view.php' );
require_once( 'class.patho_1_0_model.php' );

class Cpatho_1_0_Controller extends CExportDefaultController
{
    ...
    public function Create( $absolute_path, $export_name, $smarty, $db, $error_function = '' )
    {
        ...
        $this->m_model = new Cpatho_1_0_Model;
    ...
    {
        $this->m_view = new Cpatho_1_0_View;
