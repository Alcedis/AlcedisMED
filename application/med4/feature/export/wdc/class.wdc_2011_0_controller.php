...
require_once( 'class.wdc_2011_0_view.php' );
require_once( 'class.wdc_2011_0_model.php' );

class Cwdc_2011_0_Controller extends CExportDefaultController
{
    ...
    public function Create( $absolute_path, $export_name, $smarty, $db, $error_function = '' )
    {
        ...
        $this->m_model = new Cwdc_2011_0_Model;
    ...
    {
        $this->m_view = new Cwdc_2011_0_View;
