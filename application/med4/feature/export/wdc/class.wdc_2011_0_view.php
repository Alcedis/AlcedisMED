...
class Cwdc_2011_0_View extends CExportDefaultView
{
    ...
    {
        parent::ReadConfigs();
        $this->m_smarty->config_load( '../feature/export/wdc/wdc_2011_0.conf', 'export_wdc' );
        $this->m_configs = $this->m_smarty->get_config_vars();
    }

    public function GetTemplateFilename()
    {
        return "../feature/export/wdc/wdc_2011_0_view.tpl";
    }
