...
{elseif $view_type == 'log'}
    <table style="width:100%;">
        ...
        <tr>
            <td><a class="visible-anchor" href="index.php?page=gekid_plus&amp;feature=export&amp;action=download&amp;type=xml&amp;file={$zip_url}" style="font-size:14px; font-weight:bold; margin:5px">{$zip_filename}</a></td>
        </tr>
    </table>
    ...
    <table class="listtable bfl">
        ...
        {section name=i loop=$errorlist_data}
            ...
            <tr>
                ...
                <td class="{$class}" align="center">
                    <a href="#" onclick="execute_request( this, 'gekid_plus&amp;feature=export&amp;action=view_errors&amp;export_id={$errorlist_data[i].export_section_log_id}', null, [] )" title="{#tooltip_view_errors#}" >
        ...
        {section name=i loop=$warninglist_data}
            ...
            <tr>
                ...
                <td class="{$class}" align="center">
                    <a href="#" onclick="execute_request( this, 'gekid_plus&amp;feature=export&amp;action=view_warnings&amp;export_id={$warninglist_data[i].export_section_log_id}', null, [] )" title="{#tooltip_view_warnings#}" >
            ...
            <td class="edt" colspan="2" align="center">
                <table>
                    <tr>
                        ...
                        <td style="border: 0px;">
                            <div id="buttonbar">
                                <a class="button_large" style="margin-top: 3px;" href="index.php?page=history&feature=export&exportname=gekid_plus">{#start_history#}</a>
                            </div>
                        </td>
                    </tr>
                </table>
