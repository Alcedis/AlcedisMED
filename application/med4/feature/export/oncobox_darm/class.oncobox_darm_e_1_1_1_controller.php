...
require_once('class.oncobox_darm_e_1_1_1_view.php');
require_once('class.oncobox_darm_e_1_1_1_model.php');

class Concobox_darm_e_1_1_1_Controller extends CExportDefaultController
{
    ...
    public function Create($absolute_path, $export_name, $smarty, $db, $error_function = '')
    {
        ...
        $this->m_model = new Concobox_darm_e_1_1_1_Model;
        $this->m_model->Create($absolute_path, $this->GetExportName(), $smarty, $db, $this->m_error_function);
        $this->m_model->SetParameters($this->m_parameters);
    }

    public function BuildView($action)
    {
        $this->m_view = new Concobox_darm_e_1_1_1_View;
        $this->m_view->Create($this->m_absolute_path, $this->GetExportName(), $this->m_smarty, $this->m_db,
