...
class Concobox_darm_e_1_1_1_View extends CExportDefaultView
{
    ...
    {
        parent::ReadConfigs();
        $this->m_smarty->config_load('../feature/export/oncobox_darm/oncobox_darm_e_1_1_1.conf', 'export_oncobox_darm');
        $this->m_configs = $this->m_smarty->get_config_vars();
    }

    public function GetTemplateFilename()
    {
        return "../feature/export/oncobox_darm/oncobox_darm_e_1_1_1_view.tpl";
    }
