...
require_once( 'class.onkeyline_1_0_view.php' );
require_once( 'class.onkeyline_1_0_model.php' );

class Conkeyline_1_0_Controller extends CExportDefaultController
{
    ...
    public function Create( $absolute_path, $export_name, $smarty, $db, $error_function = '' )
    {
        ...
        $this->m_model = new Conkeyline_1_0_Model;
        $this->m_model->Create( $absolute_path, $this->GetExportName(),
    ...
    {
        $this->m_view = new Conkeyline_1_0_View;
        $this->m_view->Create( $this->m_absolute_path, $this->GetExportName(),
